          ...
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form class="space-y-4 md:space-y-6" @submit.prevent="login">
                  ...
                  <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                      Ещё нет аккаунта? <a href="#" @click="goToRegister" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Создать</a>
                  </p>
  ...
  methods: {
    async login() {
      try {
        ...
        localStorage.setItem('user-token', response.data.token); // Сохраняем токен
